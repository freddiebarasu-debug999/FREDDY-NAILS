    ...
    try {
      ...
      if (rawText) {
        try {
          ...
          console.error(
            "Promo validation response was not valid JSON:",
            rawText,
            parseError
          );
        }
