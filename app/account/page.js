...
function canCancelBooking(appointment) {
  if (!appointment) return false;

  return !isCancelledBooking(appointment);
}
                  ...
                  String(
                    ...
                    <div className="mt-7 border-t border-emerald-400/20 pt-6">
                      ...
                      <button
                        ...
                        className="mt-5 inline-flex items-center justify-center border border-red-400/30 px-6 py-3.5 text-xs font-bold uppercase tracking-[0.12em] text-red-300 transition-colors hover:border-red-300/60 hover:bg-red-400/10 disabled:cursor-not-allowed disabled:opacity-50"
                      >
                        {actionLoading ===
                        `cancel-${upcoming.id}`
                          ? "Cancelling..."
                      ...
                      <p className="mt-3 text-xs leading-relaxed text-[#817970]">
                        Cancelling a confirmed appointment releases
                        your time slot. Deposits are not automatically
                        refunded.
                      </p>
                    </div>
                  )}
